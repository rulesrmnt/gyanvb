...
Public Class frmCustomerEntryRecord2
    ...
    Private Sub frmCustomerEntryRecrod2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            frmMagazineEntry.TextBox4.Text = dr.Cells(0).Value.ToString()
            frmMagazineEntry.TextBox1.Text = dr.Cells(1).Value.ToString()
            frmMagazineEntry.ComboBox2.Text = dr.Cells(2).Value.ToString()
            frmMagazineEntry.ComboBox3.Text = dr.Cells(3).Value.ToString()
            frmMagazineEntry.TextBox3.Text = dr.Cells(4).Value.ToString()
            frmMagazineEntry.ComboBox7.Text = dr.Cells(5).Value.ToString()
            ' frmCusExtraPaper.ComboBox1.Text = dr.Cells(6).Value.ToString()
            frmMagazineEntry.TextBox5.Text = dr.Cells(7).Value.ToString()
