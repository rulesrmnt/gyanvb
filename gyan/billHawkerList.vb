...
Public Class billHawkerList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gyan.billHawkerList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedbillHawkerList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As billHawkerList = New billHawkerList()
        rpt.Site = Me.Site
        Return rpt
    End Function
