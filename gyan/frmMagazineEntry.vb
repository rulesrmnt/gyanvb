...
Public Class frmMagazineEntry
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim cb As String = "insert into tblCustomerAttendance(Date,Month,[Customer ID],[Customer Name],Address,AreaCode,[Phone no],[Hawker Name],[Paper Name],No,Rate,Balance) VALUES (@c1,@c2,@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8,@d9,@d10)"

            cmd = New SqlCommand(cb)

            cmd.Connection = con
            cmd.Parameters.Add(New SqlParameter("@c1", System.Data.SqlDbType.Date, 10, "Date"))
            cmd.Parameters.Add(New SqlParameter("@c2", System.Data.SqlDbType.NChar, 10, "Month"))
            ...
            cmd.Parameters("@c1").Value = DateTimePicker1.Text
        ...
        Try
            ...
            Dim cb As String = "insert into CustomerAttendanceEntry ([Customer ID],[Customer Name],Address,AreaCode,[Phone No],[Hawker Name],[Paper Name],No,Rate,Balance)VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8,@d9,@d10)"
            cmd = New SqlCommand(cb)
            ...
            cmd.Parameters.Add(New SqlParameter("@d7", System.Data.SqlDbType.NChar, 10, "[Paper Name]"))
            cmd.Parameters.Add(New SqlParameter("@d8", System.Data.SqlDbType.Int, 2, "No"))
            cmd.Parameters.Add(New SqlParameter("@d9", System.Data.SqlDbType.Money, 10, "Rate"))
            cmd.Parameters.Add(New SqlParameter("@d10", System.Data.SqlDbType.Money, 10, "Balance"))
    ...
    Private Sub frmMagazineEntry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        TextBox2.Text = Format(DateTimePicker1.Value, "MMM-yyyy")
    End Sub
