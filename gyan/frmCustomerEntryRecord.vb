...
Public Class frmCustomerEntryRecord
    ...
    Private Sub frmCustomerEntryRecord_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            frmCustomerDetails.ComboBox7.Text = dr.Cells(0).Value.ToString()
            frmCustomerDetails.ComboBox2.Text = dr.Cells(1).Value.ToString()

            frmCustomerDetails.ComboBox3.Text = dr.Cells(3).Value.ToString()
           
            frmCustomerDetails.ComboBox1.Text = dr.Cells(6).Value.ToString()
            frmCustomerDetails.TextBox5.Text = dr.Cells(7).Value.ToString()
